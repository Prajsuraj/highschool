...
<tbody>
					...
					while($row=mysqli_fetch_assoc($result)){
						...
						<th><a href="editadmin.php?id=<?php echo $row['id'];?>">edit</a>&nbsp<a href="deleteadmin.php?id=<?php echo $row['id'];?>">delete</a></th>
					</tr>
						<?php
					}
					?>
...
<div>For Student Detail Click Here
<a href="../ContactUs/view.php"  style="font-size:20px;">STUDENT VIEW</a>
                </div>            
